...
export const SEGMENTS: Segment[] = [
  ...
  s1({
    ...
    toLocation: "Départ ES 1 — Campuac",
    distanceKm: 34.447,
    startTime: "09:00",
    endTime: "09:50",
    section: 1,
  ...
  s1({
    ...
    liaisonNumber: 3,
    title: "Liaison",
    fromLocation: "Espeyrac (fin ES 1)",
    toLocation: "Départ ES 2 — Pont de Leth",
    distanceKm: 10.792,
    startTime: "10:08",
    endTime: "10:33",
    section: 1,
  ...
  s1({
    ...
    liaisonNumber: 4,
    title: "Liaison",
    fromLocation: "Le Nayrac (fin ES 2)",
  ...
  s1({
    ...
    liaisonNumber: 6,
    title: "Liaison",
    fromLocation: "Lassouts (fin ES 3)",
    toLocation: "Départ ES 4 — St Martin de Lenne",
    distanceKm: 18.372,
    startTime: "12:23",
    endTime: "12:57",
    section: 2,
  ...
  s1({
    ...
    title: "Liaison",
    fromLocation: "Assistance LAISSAC",
    toLocation: "Départ ES 5 — Campuac",
    distanceKm: 34.447,
    startTime: "14:25",
    endTime: "15:15",
    section: 3,
  ...
  s1({
    ...
    liaisonNumber: 9,
    title: "Liaison",
    fromLocation: "Espeyrac (fin ES 5)",
    toLocation: "Départ ES 6 — Pont de Leth",
    distanceKm: 10.792,
    startTime: "15:33",
    endTime: "15:58",
    section: 3,
  ...
  s1({
    ...
    liaisonNumber: 10,
    title: "Liaison",
    fromLocation: "Le Nayrac (fin ES 6)",
    toLocation: "Regroupement ESPALION",
    distanceKm: 17.159,
    startTime: "16:07",
    endTime: "16:36",
  ...
  s1({
    ...
    liaisonNumber: 12,
    title: "Liaison",
    fromLocation: "Lassouts (fin ES 7)",
    toLocation: "Départ ES 8 — St Martin de Lenne",
    distanceKm: 18.372,
    startTime: "17:38",
    endTime: "18:12",
    section: 3,
  ...
  s2({
    ...
    title: "Liaison",
    fromLocation: "Assistance LAISSAC",
    toLocation: "Départ ES 9 — Séverac l'Église",
    distanceKm: 4.587,
    startTime: "09:00",
    endTime: "09:15",
    section: 4,
  ...
  s2({
    ...
    liaisonNumber: 3,
    title: "Liaison",
    fromLocation: "Laissac (fin ES 9)",
    toLocation: "Départ ES 10 — Le Bousquet",
    distanceKm: 10.589,
    startTime: "09:25",
    endTime: "09:48",
    section: 4,
  ...
  s2({
    ...
    liaisonNumber: 4,
    title: "Liaison",
    fromLocation: "Le Bousquet (fin ES 10)",
    toLocation: "Départ ES 11 — Ruols",
    distanceKm: 17.409,
    startTime: "09:59",
    endTime: "10:26",
    section: 4,
  ...
  s2({
    ...
    liaisonNumber: 5,
    title: "Liaison",
    fromLocation: "Moyrazès (fin ES 11)",
  ...
  s2({
    ...
    title: "Liaison",
    fromLocation: "Assistance LAISSAC",
    toLocation: "Départ ES 12 — Séverac l'Église",
    distanceKm: 4.587,
    startTime: "14:09",
    endTime: "14:24",
    section: 5,
  ...
  s2({
    ...
    liaisonNumber: 8,
    title: "Liaison",
    fromLocation: "Laissac (fin ES 12)",
    toLocation: "Départ ES 13 — Le Bousquet",
    distanceKm: 10.589,
    startTime: "14:34",
    endTime: "14:57",
    section: 5,
  ...
  s2({
    ...
    liaisonNumber: 9,
    title: "Liaison",
    fromLocation: "Le Bousquet (fin ES 13)",
    toLocation: "Départ ES 14 — Ruols",
    distanceKm: 17.409,
    startTime: "15:08",
    endTime: "15:35",
    section: 5,
  ...
  s2({
    ...
    liaisonNumber: 10,
    title: "Liaison",
    fromLocation: "Moyrazès (fin ES 14)",
    toLocation: "Regroupement LA PRIMAUBE",
    distanceKm: 19.977,
    startTime: "15:58",
    endTime: "16:38",
  ...
  s2({
    ...
    fromLocation: "Rodez Agglomération (fin ES 15)",
    toLocation: "Podium Parc fermé RODEZ",
    distanceKm: 3.000,
    startTime: "17:38",
    endTime: "17:51",
